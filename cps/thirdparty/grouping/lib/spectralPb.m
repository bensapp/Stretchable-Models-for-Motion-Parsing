...
system(sprintf('/home/eecs/arbelaez/vision_group/grouping/lib/segment -image %s -smatrixfile %s -readlattice true -latticefile %s -dthresh 5', imgFile, simFile, latFile));
delete(latFile);
delete(imgFile);
