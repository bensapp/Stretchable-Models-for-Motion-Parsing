...
function [x,y,gx,gy,par,threshold,mag,mage,g,FIe,FIo,mago, g2nd] = quadedgep_test(I,par,threshold);
...
base_size = p * q;
id = [1:base_size]';
g2nd = reshape(FIe(id+(max_id(:)-1)*base_size),[p,q]);
mage = (g2nd>0) - (g2nd<0);
